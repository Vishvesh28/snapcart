...
// Admin option is now always available
// Removed the check that hides admin option if admin already exists
    ...
    <div className='flex flex-col items-center min-h-screen p-6 w-full'>
     ...
     <div className='flex flex-col md:flex-row justify-center items-center gap-6 mt-10'>
       {roles.map((role)=>{
        ...
        return (
          ...
          className={`flex flex-col items-center justify-center gap-3 w-48 h-44 rounded-2xl border-2 transition-all cursor-pointer ${
                    isSelected
     ...
     {error && (
       <motion.div
         ...
         className="mt-4 p-3 bg-red-50 border border-red-200 text-red-600 rounded-xl text-sm max-w-md text-center"
       >
         {error}
       </motion.div>
     )}
